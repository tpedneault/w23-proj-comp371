...
class PropertiesWidget : public Widget {
 public:
  void Render() override {
    ImGui::Begin("Properties", nullptr, ImGuiWindowFlags_AlwaysAutoResize);
    {
      ...
      DrawVec3Control("Translation", actor->transform.translation);
      DrawVec3Control("Rotation", actor->transform.rotation);
      DrawVec3Control("Scale", actor->transform.scale, 1.0f);
 ...
 private:
  void RenderTransformWidget(std::shared_ptr<Actor> actor) {
	...
	// Source : https://gist.github.com/Pikachuxxxx/8049de8bd30e02853e5f4d34c61065dc#file-imguitransformui-cpp-L10
